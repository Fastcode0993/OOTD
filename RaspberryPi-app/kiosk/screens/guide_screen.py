...
class _CameraOverlayWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._face_detected = False
        self.setStyleSheet("border: none; background: #0D0B09;")
    ...
    def paintEvent(self, event):
        ...
        if self._pixmap:
            ...
            painter.fillRect(self.rect(), QColor("#0D0B09"))
...
class _CaptureButton(QPushButton):
    def __init__(self, parent=None):
        ...
        self.setStyleSheet(f"""
            ...
            QPushButton:hover {{ background-color: #D4B47E; }}
            QPushButton:pressed {{ background-color: #B8935E; }}
